...
const FlightSearch = ({
  ...
  return (
    <Card className="w-full max-w-4xl mx-auto bg-white shadow-lg rounded-xl border-t-4 border-t-[#00256c]">
      <CardContent className="p-6">
        <div className="flex items-center justify-between mb-6 border-b pb-4">
          <div className="flex items-center">
            <Plane className="h-6 w-6 text-[#00256c] mr-2" />
            <h2 className="text-xl font-bold text-[#00256c]">
              Korean Air Flight Search
            </h2>
          </div>
        ...
        <div className="space-y-6">
          <div className="flex flex-col sm:flex-row justify-between gap-4">
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                <Users className="h-4 w-4 text-[#00256c]" />
                ...
                <Input
                  ...
                  className="w-16 border-[#00256c] focus:ring-[#00256c]"
                />
              </div>
              ...
              <div>
                <select
                  ...
                  className="p-2 border rounded-md text-sm bg-background border-[#00256c] focus:ring-[#00256c]"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="origin" className="font-medium text-[#00256c]">
                From
              </Label>
              <div className="relative">
                <MapPin className="absolute left-3 top-3 h-4 w-4 text-[#00256c]" />
                <select
                  id="origin"
                  value={origin}
                  onChange={(e) => setOrigin(e.target.value)}
                  className="w-full p-2 pl-10 border rounded-md border-[#00256c] focus:ring-[#00256c]"
                >
            ...
            <div className="space-y-2">
              <Label
                htmlFor="destination"
                className="font-medium text-[#00256c]"
              >
                To
              </Label>
              <div className="relative">
          ...
          <div className="space-y-2">
            <Label className="font-medium text-[#00256c]">Dates</Label>
            <Popover>
              <PopoverTrigger asChild>
                <Button
                  variant="outline"
                  className="w-full justify-start text-left font-normal border-[#00256c] focus:ring-[#00256c]"
                >
                  <CalendarIcon className="mr-2 h-4 w-4 text-[#00256c]" />
                  {date?.from ? (
                    tripType === "one-way" ? (
          ...
          <Button
            className="w-full bg-[#00256c] hover:bg-[#001d52] text-white py-3 rounded-md transition-colors font-medium text-lg"
